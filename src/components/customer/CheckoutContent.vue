<template>
  <div class="py-0 mt-0 pt-0">
      ...
      <v-row>
        <v-col cols="12">
          <v-card
            ...
            :class="{ 'selected-card': activeIndex === index }"
            variant="outlined"
            height="70px"
            class="custom-radius d-flex align-center px-4 py-3 mb-3"
          >
            <v-col
              v-if="payment.title === 'Wallet'"
              class="px-0 py-0 d-flex w-100 align-center"
            >
    ...
    >
      ...
      <v-btn color="black" height="55px" class="w-100" @click="confirmSchedule"
        >Confirm</v-btn
      >
    </Modal>
    ...
    >
      <div class="d-flex justify-space-between align-center">
        <span class="font-weight-bold"
          >Your order has been successfully placed.</span
        >
      </div>
      <div class="my-2">
      ...
      <div class="mt-auto">
        <v-btn @click="closeConfirmationModal" class="w-100" color="black"
          >Okay</v-btn
        >
      </div>
    </Modal>
